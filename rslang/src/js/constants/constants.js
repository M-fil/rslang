...
const aboutTeam = {
  NAME_FILANOVVICH: 'Максим Филанович',
  ...
  ABOUT_ANDREEV: '',
  ABOUT_SHNIRKEVICH: '',
  WORK_FILANOVVICH: `Авторизация/Регистрация${'<br>'}
  Главная страница приложения${'<br>'}
  Основная игра${'<br>'}
  Методика интервального повторения${'<br>'}
  мини-игра SpeakIt${'<br>'}
  Словарь${'<br>'}
  Описание для страницы «Промо»${'<br>'}
  Дизайн и адаптивы для страниц: мини-игра SpeakIt, Главная страница приложения, Основная игра`,
  WORK_LATUSHKINA: `Мини-игра «Саванна»${'<br>'}
  Общие элементы для мини-игр: модальные окна, краткосрочная статистика, стартовая страница${'<br>'}
  Прелоудер для всего приложения${'<br>'}
  Описание для страницы «Промо»${'<br>'}
  Видео для страницы «Промо»${'<br>'}
  Дизайн и адаптивы для страниц: «Промо», «О Команде», мини-игра «Саванна»${'<br>'}
  Страница «О Команде»`,
  WORK_ANTONOV: `мини-игра «Найди пару» («Своя игра»)${'<br>'}
  Настройки${'<br>'}
  Логика для страницы «Статистика»${'<br>'}
  Дизайн и адаптивы для страниц: Настройки, Статистика, мини-игра «Найди пару».
  `,
  WORK_ZHDANOV: `Мини-игра «Аудиовызов»${'<br>'}
  Графики для страницы «Статистика»${'<br>'}
  Дизайн и адаптивы для страниц: Статистика, мини-игра «Аудиовызов»
  `,
  WORK_ANDREEV: `Мини-игра «Спринт»${'<br>'}
  Дизайн и адаптив для мини-игры «Спринт» и Авторизации/Регистрации
  `,
  WORK_SHNIRKEVICH: `Мини-игра «English Puzzle»${'<br>'}
  Интернационализация страницы в качестве допфункционала для всего проекта${'<br>'}
  Дизайн и адаптив для мини-игры «English Puzzle» и страницы «Словарь»${'<br>'}
  Стили и адптивы для общих элементов мини-игр
  `,
};
