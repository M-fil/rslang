...
const promoPage = {
  ...
  После нажатия на кнопку «Снова» слово появится в изучении на текущей тренировке.
  ...
  Эти параметры заданы по умолчанию. Интервалы повторения пользователь может изменять в настройках, что дает ему возможность подстроить изучение слов под себя.
  Если интервалы повторения для слов еще не истекли, то недостающие слова для тренировки будут браться из новых слов.
  `,
  SETTING: 'Настройки',
