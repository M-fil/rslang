const START_WINDOW = {
  ...
  descrption: 'Нажимайте на слова, собирайте фразы.',
  functionality: 'Слова могут быть перетянуты. Выберайте подсказки. После угаданного предложения используйте бонус.',
  startButton: 'Старт',
};
