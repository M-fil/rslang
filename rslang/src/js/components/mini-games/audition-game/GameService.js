...
export default class GameService {
  ...
  clstest() {
    this.closeButton.modalWindow.modalClose.addEventListener('click', () => {
      this.preloader.hide();
      this.closed = true;
    });
  }
  ...
  genGame() {
    ...
    if (this.isHintAvailable) this.auditionGameHintBtn = create('div', 'audition-game__hint__button', '', hintCont);
